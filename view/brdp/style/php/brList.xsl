              ...
              <tr>
                <td>
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" filterBy="ident" placeholder="search ident.." onkeypress="Brdp.BrSearch.evetListener(this,event)"/>
                  </div>
                </td>
                <td>
                  <div class="input-group">
                    <input type="number" class="filterSort input-group-text p-0" style="width: 30px" for="title" id="" max="5" min="1" value="2"/>
                    <input type="text" class="form-control" filterBy="title" placeholder="search title.." onkeypress="Brdp.BrSearch.evetListener(this,event)"/>
                  </div>
                </td>
                <td>
                  <div class="input-group">
                    <input type="number" class="filterSort input-group-text p-0" style="width: 30px" for="category" id="" max="5" min="1" value="3"/>
                    <input type="text" class="form-control" filterBy="category" placeholder="search category.." onkeypress="Brdp.BrSearch.evetListener(this,event)"/>
                  </div>
                </td>
                <td>
                  <div class="input-group">
                    <input type="number" class="filterSort input-group-text p-0" style="width: 30px" for="audit" id="" max="5" min="1" value="4"/>
                    <input type="text" class="form-control" filterBy="audit" placeholder="search audit.." onkeypress="Brdp.BrSearch.evetListener(this,event)"/>
                  </div>
                </td>
                <td>
                  <div class="input-group">
                    <input type="number" class="filterSort input-group-text p-0" style="width: 30px" for="decision" id="" max="5" min="1" value="5"/>
                    <input type="text" class="form-control" filterBy="decision" placeholder="search decision.." onkeypress="Brdp.BrSearch.evetListener(this,event)"/>
                  </div>
                </td>
              </tr>
            </thead>
